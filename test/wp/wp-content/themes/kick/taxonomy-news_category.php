            ...
            <?php
              ...
              if($the_query->have_posts()){
                ...
                if($year != get_the_date('Y')){
                  $year = get_the_date('Y');
                  echo '<li><a href="/news/'.$category.'/?='.$year.'">'.$year.'年</a></li>';
                }
              endwhile;
              wp_reset_postdata();
              }
    ...
    <div class="news_list">
      ...
      <div class="news_list_item<?php foreach($terms as $term){echo ' '. $term -> slug;}?>">
        <a href="<?php the_permalink(); ?>">
          ...
          <time class="news_list_time <?php echo $year; ?>"><?php the_time("Y.m.d"); ?></time>
...
<div class="map js-anim"><div class="googlemap"></div></div>
